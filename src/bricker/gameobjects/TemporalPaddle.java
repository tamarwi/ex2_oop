...
public class TemporalPaddle extends Paddle {
    ...
    public TemporalPaddle(Vector2 topLeftCorner, Vector2 dimensions, Renderable renderable,
        ...
        super(topLeftCorner, dimensions, renderable, inputListener); // Call superclass constructor
    ...
    public boolean shouldCollideWith(GameObject other) {
        return !other.getTag().equals(Constants.WALL_TAG); // Paddle should not collide with walls
    }
}
